...
const postData: DataType[] = [
    {
        name: "Robert Fox",
        profession: 'Teacher',
        comment: 'This platform helped me overcome my fear of speaking in front of a crowd. The exercises are easy to follow, and the progress I’ve made is incredible!',
        imgSrc: '/images/testimonial/user1.svg',
    },
    {
        name: "Leslie Alexander",
        profession: 'Graphic Designer',
        comment: 'The community support section is amazing! It’s comforting to share my experiences with people who understand and relate to my struggles.',
        imgSrc: '/images/testimonial/user2.svg',
    },
    {
        name: "Cody Fisher",
        profession: 'Entrepreneur',
        comment: 'The resources are helpful, but I wish there were more interactive features like live workshops. Still, it’s a great platform for managing social anxiety.',
