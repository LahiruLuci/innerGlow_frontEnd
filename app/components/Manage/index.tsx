...
const names = [
    {
        heading: "Starter Confidence Plan",
        price: 41,
        user: 'per user, per month',
        button: "Start My 15-day Trial",
        profiles: '5 Group Sessions Weekly',
        posts: '5 Social Skills Exercises',
        templates: "400+ Resources",
        view: "Progress Tracker",
        support: 'Live Chat Support',
        category: 'yearly'
    },
    {
        heading: "Basic Self-Help Plan",
        price: 29,
        user: 'per user, per month',
        button: "Start My 15-day Trial",
        profiles: '10 Anxiety Techniques',
        posts: '5 Guided Meditations',
        templates: "600+ Tips",
        view: "Self-Help Calendar",
    ...
    },
    {
        ...
        user: 'per user, per month',
        button: "Start My 15-day Trial",
        profiles: '100+ Therapy Sessions',
        posts: 'Daily Coping Exercises',
    ...
    return (
        <div id="services-section">
            <div className='mx-auto max-w-7xl sm:py-20 lg:px-8 my-16'>
                <h3 className='text-center text-4xl sm:text-60xl font-black'>Empower Yourself to Overcome Social Phobia –  <br /> Choose the Right Plan.</h3>
